...
_G.packer_plugins = {
  ...
  deus = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/deus",
...
-- Config for: deus
time([[Config for deus]], true)
try_loadstring("\27LJ\2\n4\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0\21colorscheme deus\bcmd\bvim\0", "config", "deus")
time([[Config for deus]], false)
